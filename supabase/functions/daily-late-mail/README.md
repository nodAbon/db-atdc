...
This version sends a direct 1:1 message to one NAVER WORKS user. No Channel ID is needed. The recipient's NAVER WORKS User ID is required, and the API requires the `bot.message` scope.
